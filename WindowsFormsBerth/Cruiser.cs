...
{
    public class Cruiser : WarShip, IEquatable<Cruiser>
    {
        [Required]
        public Color DopColor { private set; get; }

        [Required]
        public bool IsWithGuns { internal set; get; }
        
        /// <summary>
        /// Признак наличия вертолетной площадки
        /// </summary>
        [Required]
        public bool IsWithHelicopter { internal set; get; }
        ...
        /// <summary>
        /// Метод интерфейса IEquatable для класса Berth
        /// </summary>
